...
def show_cv2_image(image, title='image'):
  ...
  cv2.imwrite(f'{title}_{datetime.datetime.now().strftime("%Y%m%d%H%M%S")}.png', image)
...
def main():
  # k = rotate_test(cv2.imread(dataset_path('chess/Screenshot 2567-12-07 at 21.28.15.png')))
  k = get_k(cv2.imread(dataset_path('chess/Screenshot 2567-12-07 at 21.28.15.png')))
  print(k)
